...
List<Map<String, Object>> customOIDS = [
  {
    'identifierString': '1.2.3.4.5',
    'readableName': 'someName',
...
class ASN1ObjectIdentifierException {
...
class ASN1ObjectIdentifiers {
  ...
  final List<Map<String, Object>> _OIDS = oi;
  ...
  Map<String, Object> getOIDByIdentifierString(String identifierString) {
    return _OIDS.firstWhere(
        ...
        orElse: () => throw ASN1ObjectIdentifierException(
